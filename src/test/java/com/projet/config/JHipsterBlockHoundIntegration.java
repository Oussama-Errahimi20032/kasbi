...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.projet.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.projet.security.DomainUserDetailsService", "createSpringSecurityUser");

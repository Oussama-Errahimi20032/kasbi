...
/**
 * REST controller for managing {@link com.projet.domain.Parcelle}.
 */
@RestController
...
public class ParcelleResource {
            ...
            .flatMap(exists -> {
                ...
                Mono<Parcelle> result = parcelleRepository
                    ...
                    .map(existingParcelle -> {
                        if (parcelle.getLibelle() != null) {
                            existingParcelle.setLibelle(parcelle.getLibelle());
                        }
    ...
    public Mono<List<Parcelle>> getAllParcelles(
        ...
        if (eagerload) {
            ...
            return parcelleRepository.findAll().collectList();
        }
    }
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<Parcelle>> getParcelle(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteParcelle(@PathVariable("id") Long id) {

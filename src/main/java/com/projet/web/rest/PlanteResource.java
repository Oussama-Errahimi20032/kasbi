...
/**
 * REST controller for managing {@link com.projet.domain.Plante}.
 */
@RestController
...
public class PlanteResource {
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<Plante>> getPlante(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deletePlante(@PathVariable("id") Long id) {

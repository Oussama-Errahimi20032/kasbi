...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEPLANTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TYPEPLANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TYPEPLANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TYPEPLANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TYPEPLANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TYPEPLANTE actions', async () => {
      const expectedActions = [
        {

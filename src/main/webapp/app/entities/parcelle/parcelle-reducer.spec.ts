...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './parcelle.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARCELLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARCELLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARCELLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARCELLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARCELLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARCELLE actions', async () => {
      const expectedActions = [
        {

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './plantage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANTAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLANTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLANTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLANTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLANTAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLANTAGE actions', async () => {
      const expectedActions = [
        {

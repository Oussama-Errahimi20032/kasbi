...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ferme.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FERME_LIST actions', async () => {
    ...
    it('dispatches FETCH_FERME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FERME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FERME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FERME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FERME actions', async () => {
      const expectedActions = [
        {

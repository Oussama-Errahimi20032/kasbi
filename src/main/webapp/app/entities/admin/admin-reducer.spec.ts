...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './admin.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_ADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADMIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADMIN actions', async () => {
      const expectedActions = [
        {

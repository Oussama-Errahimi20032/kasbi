  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="pharmaGesApp.admin.home.createOrEditLabel" data-cy="AdminCreateUpdateHeading">
            <Translate contentKey="pharmaGesApp.admin.home.createOrEditLabel">Create or edit a Admin</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">

...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './plante.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLANTE actions', async () => {
      const expectedActions = [
        {
